...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ExistsAssociationException.class)
    public ResponseEntity<Object> handleExistsAssociationException(ExistsAssociationException e) {
        var retorno = new ErroResponse(" hava a association!");
        return ResponseEntity.status(HttpStatus.CONFLICT).body(retorno);
    }
